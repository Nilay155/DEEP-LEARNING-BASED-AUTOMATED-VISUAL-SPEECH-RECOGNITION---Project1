...
if selected_video:
    ...
    with col2:
        ...
        if model is None:
            ...
            # Dropdown for language selection (default: English)
            selected_language = st.selectbox(
                "Select language to translate the predicted text:",
            ...
            # Translate only if selected language is not English
            if selected_language != "English":
                ...
                st.markdown(f"### 🌍 Translated Transcript ({selected_language})")
                st.markdown(f"**{translated_text}**")
            else:
                st.markdown("### 🌍 Translated Transcript (English)")
